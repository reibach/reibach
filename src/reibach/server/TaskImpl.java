...
public class TaskImpl extends AbstractDBObject implements Task
{
  ...
  /**
   * @see reibach.rmi.Task#getProject()
   */
  ...
  /**
   * @see reibach.rmi.Task#setProject(reibach.rmi.Project)
   */
  ...
  /**
   * @see reibach.rmi.Task#getComment()
   */
  ...
  /**
   * @see reibach.rmi.Task#setComment(java.lang.String)
   */
  ...
  /**
   * @see reibach.rmi.Task#getEffort()
   */
