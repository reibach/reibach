...
public abstract class AbstractDBSupportImpl implements DBSupport
{
  ...
  /**
   * @see reibach.rmi.DBSupport#execute(java.sql.Connection, java.io.File)
   */
  ...
  /**
   * @see reibach.rmi.DBSupport#install()
   */
  ...
  /**
   * @see reibach.rmi.DBSupport#getTransactionIsolationLevel()
   */
  ...
  /**
   * @see reibach.rmi.DBSupport#checkConnection(java.sql.Connection)
   */
