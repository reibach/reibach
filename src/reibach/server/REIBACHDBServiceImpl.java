 ...
 * @author willuhn
 */
public class REIBACHDBServiceImpl extends DBServiceImpl implements REIBACHDBService
{
   ...
   * @throws RemoteException
   */
  public REIBACHDBServiceImpl(String driverClass) throws RemoteException
  {
    super();
    MultipleClassLoader cl = Application.getPluginLoader().getPlugin(REIBACH.class).getResources().getClassLoader();
  ...
  /**
   * @see reibach.rmi.REIBACHDBService#checkConsistency()
   */
  public void checkConsistency() throws RemoteException, ApplicationException
  {
    Logger.info("init update provider");
    // UpdateProvider provider = new REIBACHUpdateProvider(getConnection(),VersionUtil.getVersion(this,"db"));
  ...
  /**
   * @see reibach.rmi.REIBACHDBService#install()
   */
  ...
  /**
   * @see reibach.rmi.REIBACHDBService#getSQLTimestamp(java.lang.String)
   */
  ...
  /**
   * @see reibach.rmi.REIBACHDBService#getDriver()
   */
...
/*********************************************************************
 * $Log: REIBACHDBServiceImpl.java,v $
