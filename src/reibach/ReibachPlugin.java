 ...
 */
public class ReibachPlugin extends AbstractPlugin
{
  ...
  public void install() throws ApplicationException
  {
    ...
    try {
			...
			PluginResources res = Application.getPluginLoader().getPlugin(ReibachPlugin.class).getResources();
			Manifest mf = Application.getPluginLoader().getManifest(ReibachPlugin.class);
