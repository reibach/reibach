...
class SiteController extends Controller
{
    ...
    public function actionLogin()
    {
		...
		//Kunde:
		// get Customer 
		//$mandator = Customer::findOne($user->customer_id);
		
		
		 //$mandator = Mandator::findOne(19);
        ...
        //$mandator_active = Mandator::findOne()
			//->where('user_id > :user_id', [':user_id' => $userid]);
		

            // DefaultMandanten holen
            //$mandator_active = getDefaultMandator();
			//$mandator->user_id = Yii::$app->user->id;		
			//$mandator_active = $mandator->getDefaultMandator(Yii::$app->user->id);
